...
public class CoachListActivity extends Activity implements SearchView.SearchViewListener {
    ...
    public static void setHintSize(int hintSize) {
        CoachListActivity.hintSize = hintSize;
    }
    ...
    private void initViews() {
        ...
        lvResults = (ListView) findViewById(R.id.coach_lv_search_results);
        searchView = (SearchView) findViewById(R.id.coach_search_layout);
        //设置监听
        searchView.setSearchViewListener(CoachListActivity.this);
        //设置adapter
        searchView.setTipsHintAdapter(hintAdapter);
        searchView.setAutoCompleteAdapter(autoCompleteAdapter);
        lvResults.setAdapter(new MyListViewAdapter(list, R.layout.coach_list_item,
                CoachListActivity.this));

        lvResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(CoachListActivity.this, position + "", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(CoachListActivity.this, CoachDetailActivity.class);
