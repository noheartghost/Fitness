...
public class MyFriendsActivity extends Activity implements SearchView.SearchViewListener {
    ...
    public static void setHintSize(int hintSize) {
        MyFriendsActivity.hintSize = hintSize;
    }
    ...
    private void initViews() {
        ...
        lvResults = (ListView) findViewById(R.id.friend_lv_search_results);
        searchView = (SearchView) findViewById(R.id.friend_search_layout);
        //设置监听
        searchView.setSearchViewListener(MyFriendsActivity.this);
        //设置adapter
        searchView.setTipsHintAdapter(hintAdapter);
        searchView.setAutoCompleteAdapter(autoCompleteAdapter);
        lvResults.setAdapter(new MyListViewAdapter(list, R.layout.friend_item,
                MyFriendsActivity.this));

        lvResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(MyFriendsActivity.this, position + "", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MyFriendsActivity.this, PersonsActivity.class);
